...
export const useForumStore = defineStore("forumStore", {
    ...
    actions: {
        ...
        fetchItem({ resource, id, emoji, handleUnsubscribe = null}) {
        ...
        async signInWithGoogle() {
            ...
            if (!userDoc.exists) {
                return this.createUser({ id: user.uid, name: user.displayName, email: user.email, username: user.email, avatar: user.photoURL })
            }
